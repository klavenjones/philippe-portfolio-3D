...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  await db.execute(sql`
   CREATE TYPE "public"."enum_artworks_category" AS ENUM('intro', 'oils', 'food-and-shoes', 'drawings');
  CREATE TYPE "public"."enum_artworks_wall" AS ENUM('auto', 'left', 'right');
  CREATE TABLE "artworks" (
  	...
  	"dimensions" varchar,
  	"category" "enum_artworks_category" DEFAULT 'drawings' NOT NULL,
  	"wall" "enum_artworks_wall" DEFAULT 'auto',
  	"frame_color" varchar,
  	"display_max_dim" numeric,
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  ...
  DROP TYPE "public"."enum_artworks_wall";`)
}
